...
class Model3d(models.Model):
    ...
    image_path = models.ImageField(upload_to='images', verbose_name="Фото модели", default="images/1.png")
...
class Sell3d(models.Model):
    ...
    del_date = models.DateTimeField(auto_now=True, verbose_name="Дата удаления")
    compl_date = models.DateTimeField(auto_now=True, verbose_name="Дата завершения")
