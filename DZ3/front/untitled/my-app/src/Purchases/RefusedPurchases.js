...
function RefusedPurchases(){

    return (
        <div>
            <a href={`../`}>Начало/</a>
            <a href = {'/models/purchases'}>Заказы/</a>
            <a href = {'/models/refused'}>Отклонённые/</a>
            <br />
                ...
                <div key = {purchase.id} className="manga_block">
                        {
                            purchase.status == 2 ?
                                <div>
                                    ...
                                    <Link className="purchase_link" to={`/models/resend/${purchase.id}`}>К заказу</Link>
                                </div>
                                :
...
export default RefusedPurchases;